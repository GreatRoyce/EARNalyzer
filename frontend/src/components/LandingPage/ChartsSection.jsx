  ...
  if (active && payload && payload.length) {
    return (
      <div
        ...
        style={{ borderColor: MANUSCRIPT_COLORS.charcoal, fontFamily: "serif" }}
      >
        <p
...
const PieChartCustomTooltip = ({ active, payload }) => {
  if (active && payload && payload.length) {
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8 sm:mb-12 lg:mb-16">
          ...
          >
            ...
            <p className="text-sm sm:text-base lg:text-lg opacity-90 text-white">
        ...
        <div className="grid  grid-cols-1 sm:grid-cols-2 xl:grid-cols-2 gap-6 sm:gap-8 lg:gap-10 items-start">
          ...
          >
            ...
            <p
              className="text-xs sm:text-sm text-center mb-3 opacity-75"
        ...
        <div className="mt-8 sm:mt-10 text-center max-w-2xl mx-auto">
          ...
          >
            ...
            <p
              ...
              style={{ color: MANUSCRIPT_COLORS.sepia }}
            >
              Your feasting expenses show seasonal variation, while market
              wares remain steady. Consider allocating more to your coffers
              during abundant months.
            </p>
          </div>
        </div>
